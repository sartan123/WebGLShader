window.onload = function(){
    ...
    var uniInvLocation = gl.getUniformLocation(programs, "invMatrix");
    var uniEyePositionLocation = gl.getUniformLocation(programs, "EyePosition");
    var uniEyePointLocation = gl.getUniformLocation(programs, "EyePoint");
    ...
    function render(){
        ...
        gl.uniformMatrix4fv(uniInvLocation, false, invMatrix);
        gl.uniform3fv(uniLightLocation, [1.0, 1.0, 1.0]);
        gl.uniform3fv(uniEyePositionLocation, cameraPosition);
        gl.uniform3fv(uniEyePointLocation, cameraPoint);
